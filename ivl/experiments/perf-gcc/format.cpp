...
namespace __format
{
  ...
  template<typename _CharT, typename _OutIter>
    ...
    public:
      ...
      constexpr format_to_n_result<_OutIter>
      _M_finish() &&
      {
	if (this->_M_used().size() != 0)
...
/// @endcond
  ...
  template<typename _Context>
	...
	const _Format_arg* _M_args;       // Active when _M_packed_size == 0
      ...
      constexpr typename __format::_Arg_t
	...
	basic_format_args(const _Store<_Args...>& __store) noexcept;
      ...
      [[nodiscard,__gnu__::__always_inline__]]
      constexpr basic_format_arg<_Context>
