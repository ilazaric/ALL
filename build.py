...
def deduce_file_targets(path):
    ...
    if file_has_reg_variant:
        all_targets[name] = TargetState(path, added_compiler_flags, added_compiler_flags_tail + ["-include", "ivl/reflection/ivl_main_handler", "-lstdc++exp"], unordered_dependencies)
