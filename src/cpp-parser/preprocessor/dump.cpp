...
struct ModuleFile {
  std::unique_ptr<
    std::variant<
      std::tuple<
        std::optional<PpGlobalModuleFragment>,
        PpModule,
        std::optional<Group>,
...
struct IfSection {
  std::unique_ptr<
    std::variant<
      std::tuple<
        IfGroup,
        std::optional<ElifGroups>,
        std::optional<ElseGroup>,
        EndifLine
      >
    >
  > data;
