...
def init_login():
    ...
    if driver.current_url == 'https://codeforces.com/enter':
        ...
        time.sleep(1.5)
        wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, '#sidebar > div:nth-child(5) > div.caption.titled')))
        # wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, '#sidebar > div:nth-child(1) > div.caption.titled')))
