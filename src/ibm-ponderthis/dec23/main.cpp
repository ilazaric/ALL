...
int main() {
  ...
  {
    SCOPE_TIMER;
    LOG(compute_f_more_faster(4e6));
  }
  {
    SCOPE_TIMER;
    LOG(compute_f_more_faster(4.5e6));
  }
  {
    SCOPE_TIMER;
    LOG(compute_f_more_faster(5e6));
  }
  {
    SCOPE_TIMER;
    LOG(compute_f_more_faster(7e6));
  }
  {
    SCOPE_TIMER;
    LOG(compute_f_more_faster(1e7));
  }
  {
    SCOPE_TIMER;
    LOG(compute_f_more_faster(4e7));
  }
  return 0;
